Create a new javascript file named ***MintNFT.js***. This file will contain all the major front-end code and combine all the other components functionalities.
